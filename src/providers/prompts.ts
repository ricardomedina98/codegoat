...
const DOCS_SYSTEM_PROMPTS: Record<DocsLevel, string> = {
  ...
  function:
    ...
    "JSDoc/TSDoc for TypeScript/JavaScript, docstrings for Python, godoc comments for Go, YARD docs for Ruby, Javadoc for Java, rustdoc (///) for Rust, Doxygen for C/C++, PHPDoc for PHP. " +
...
const DOCS_USER_SUFFIXES: Record<DocsLevel, string> = {
  ...
  function:
    ...
    "generate documentation comments (JSDoc/TSDoc for JS/TS, docstrings for Python, godoc for Go, YARD for Ruby, Javadoc for Java, rustdoc for Rust, Doxygen for C/C++, PHPDoc for PHP). Format as:\n\n" +
    "### `<filepath>` — `<exportName>`\n\n" +
    "```typescript\n" +
